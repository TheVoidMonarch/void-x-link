...
class TestResumableTransfer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        file_transfer_resumable.FILE_METADATA_FILE = os.path.join(
            self.test_dir, "file_metadata.json")
    ...
    def test_start_resumable_download(self, mock_encrypt_message):
        ...
        stored_file_path = os.path.join(
            file_transfer_resumable.FILE_STORAGE_DIR,
            "download_test.txt")
    ...
    def test_send_file_chunk(self, mock_encrypt_message):
        ...
        # Set up mocks
        mock_encrypt_message.side_effect = lambda x: b"encrypted_" + \
