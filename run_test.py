    ...
    def authenticate(self):
        ...
        try:
            ...
            for msg in self.received_messages:
                if isinstance(
                        msg,
                        dict) and msg.get("type") == "system" and "Welcome" in msg.get(
                        "content",
                        ""):
        ...
        try:
            ...
            for msg in self.received_messages:
                if isinstance(msg, dict) and msg.get(
                        "type") == "file_ready" and msg.get("filename") == filename:
                    ready = True
                    break
...
def run_comprehensive_test():
    ...
    try:
        ...
        file_notification = user_client.wait_for_message(
            condition=lambda msg: isinstance(msg, dict)
            and msg.get("type") == "notification"
            and "shared file" in msg.get("content", "")
        )
