                ...
                if message_type == "message":
                    ...
                    with message_lock:
                        if sender == current_user:
                            color = getattr(
                                Colors, config["theme"]["user_msg"].upper(), Colors.GREEN)
                        else:
                            color = getattr(
                                Colors, config["theme"]["other_msg"].upper(), Colors.WHITE)
                    ...
                    with message_lock:
                        print(
                            f"{Colors.CYAN}[FILE] Server is ready to receive file: {filename}{Colors.RESET}")
